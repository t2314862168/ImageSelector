package cn.tangxb.imageselector.controller;
...
public class AlbumController {
	...
	public List<AlbumModel> getAlbums() {
		...
		AlbumModel current = new AlbumModel(recentPhoto, 0, cursor.getString(cursor.getColumnIndex(ImageColumns.DATA)), true); // "最近照片"相册
		albums.add(current);
		do {
